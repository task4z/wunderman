...
export const FIRST_LETTER_UPPERCASE_TRUE = 'True';
export const FIRST_LETTER_UPPERCASE_FALSE = 'False';
...
export type Type = typeof MOVIE_TYPE | typeof SERIES_TYPE;
export type CapitalCaseBooleanString =
  | typeof FIRST_LETTER_UPPERCASE_TRUE
  | typeof FIRST_LETTER_UPPERCASE_FALSE;
export type Watched = CapitalCaseBooleanString;
export type Saved = CapitalCaseBooleanString;
type Show = {
  Title: string;
  Year: string;
  Rated: string;
...
export type Shows = Movie | Series;
export type ListOfShows = Array<Shows>;

const movies: ListOfShows = [
  {
    Title: 'Blade Runner',
    Year: '1982',
    Rated: 'R',
  ...
  },
  {
    ...
    Awards: 'N/A',
    Poster:
      'https://m.media-amazon.com/images/M/MV5BM2U1ZjQ0ZmItNGE3Mi00MmIyLTk3YWQtNmZlMTQwNTVlZTViXkEyXkFqcGdeQXVyMTkwNDA0OA@@._V1_SX300.jpg',
  ...
  },
  {
    ...
    Writer:
      'John Grisham (novel), Francis Ford Coppola (screenplay), Michael Herr (narration)',
    ...
    Poster:
      'https://m.media-amazon.com/images/M/MV5BMjdlMjI2ZjgtN2ViOS00ZmI0LWE0ZTMtZjg1ZjczYWYzOGZjL2ltYWdlL2ltYWdlXkEyXkFqcGdeQXVyNjc1NTYyMjg@._V1_SX300.jpg',
    Ratings: [
  ...
  },
  {
    ...
    Writer:
      'Thierry Jonquet (novel), Pedro Almodóvar, Agustín Almodóvar (collaboration)',
    ...
    Poster:
      'https://m.media-amazon.com/images/M/MV5BYmFmNjY5NDYtZjlhNi00YjQ5LTgzNzctNWRiNWUzNmIyNjc4XkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_SX300.jpg',
    Ratings: [
  ...
  },
  {
    ...
    Poster:
      'https://m.media-amazon.com/images/M/MV5BMjA0NTUxMjY1OV5BMl5BanBnXkFtZTcwNjI2OTMzMQ@@._V1_SX300.jpg',
    Ratings: [
      { Source: 'Internet Movie Database', Value: '7.6/10' },
  ...
  },
  {
    ...
    Writer:
      'Billy Wilder (screenplay), I.A.L. Diamond (screenplay), Robert Thoeren (suggested by a story by), Michael Logan (suggested by a story by)',
  ...
  },
  {
    ...
    Poster:
      'https://m.media-amazon.com/images/M/MV5BMTM3MzM3NDE5MV5BMl5BanBnXkFtZTcwNDE5MTUxNA@@._V1_SX300.jpg',
    Ratings: [
  ...
  },
  {
    ...
    Poster:
      'https://m.media-amazon.com/images/M/MV5BMTYxODgwNDQyOF5BMl5BanBnXkFtZTcwMzM2NjkwOQ@@._V1_SX300.jpg',
    Ratings: [
  ...
  },
  {
    ...
    Poster:
      'https://m.media-amazon.com/images/M/MV5BMDdjZDhlOWUtOWQ4YS00ZjdhLWJkOTktMTVlYTY2Y2IwMTMxXkEyXkFqcGdeQXVyMzIzNDU1NTY@._V1_SX300.jpg',
    Ratings: [
  ...
  },
  {
    ...
    Poster:
      'https://m.media-amazon.com/images/M/MV5BYWM1NWFjMDItODg5OS00MWUwLWFjNWUtOGZkZWM3NmRiMWNjXkEyXkFqcGdeQXVyMTA0MjU0Ng@@._V1_SX300.jpg',
    Ratings: [
      { Source: 'Internet Movie Database', Value: '7.6/10' },
  ...
  },
  {
    ...
    Poster:
      'https://m.media-amazon.com/images/M/MV5BMjExMDM0OTItY2E1YS00N2Y4LWFlNGMtOTgyNmFlMjIyOTgxXkEyXkFqcGdeQXVyMTA0MjU0Ng@@._V1_SX300.jpg',
    Ratings: [
